...
const login_fields = $$(["login_password", "login_submit", "login_shared_recovery", "login_word_recovery", "login_restart"]) as Array<HTMLInputElement>;
...
async function login_submitButtonListener(sender : LoginPane) {
	...
	const password = ($("login_password") as HTMLInputElement).value;
	($("login_password") as HTMLInputElement).value = "";
